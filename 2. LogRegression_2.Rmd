...
clean_data <- read.csv("ReducedWaterTraining.csv")
clean_data <- clean_data[-1]
trainLabels <- read.csv("TrainingSetLabels.csv")
head(clean_data, 2)
```
...
```{r}
clean_test <- read.csv("ReducedWaterTest.csv")
head(clean_test,2)
```
...
write.csv(clean_test, "Label_Log_1.csv")
```
